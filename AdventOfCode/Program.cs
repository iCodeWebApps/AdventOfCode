...
namespace AdventOfCode
{
    ...
    {
        public static bool[,] GetIntersections(this bool[,] grid1, bool[,] grid2)
        {
            var result = new bool[grid1.GetLength(0), grid1.GetLength(1)];
        ...
        public static List<Coordinate> GetIntersectionCoordinates(this bool[,] grid)
        {
        ...
        public static bool[,] AddRoute(this bool[,] grid, Coordinate origin, List<Step> steps)
        {
        ...
        public static bool[,] TakeStep(this bool[,] grid, Coordinate position, Step step)
        {
            ...
            switch (step.Direction)
            {
                case 'R':
                    ...
                    grid[position.Row, position.Column] = true; // Mark current square
                    break;
                case 'D':
        ...
        public static Coordinate GetOrigin(this bool[,] grid)
        {
